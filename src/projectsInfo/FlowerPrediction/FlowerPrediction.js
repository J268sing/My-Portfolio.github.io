    ...
    render() {
        return (
            <div>
                            ...
                            <Row>
                                ...
                                <Col xs={12} md={6} xg={6}>
                                    <div className="check-flower-prediction">
                                        <p className="p-layout">This is a CNN model bulit by fine-tuning the pre-trained
                                        VGG19 model by modifiying the classifying layer with custom feed forward network
                                        that has 2 hidden layers and ReLU activation functions.
                                        ...
                                        <Card className="card-flower-prediction shadow card1-pytorch  bg-dark rounded" text="white" >
                                            <Card.Body>Model Specifications: VGG19, Optimizer: Adam, Activation Function: ReLu and Softmax,
                                                Pooling Layer: MaxPool2d, number of inputs: 25088, number of classes: 102, number of epochs: 8
                                            </Card.Body>
                                        </Card>
                                    </div>
                                </Col>
                ...
                <Container fluid className="container-flower-prediction space-mobile-flower-prediction">Link to the trained dataset:
                  <a target="_blank" href="https://drive.google.com/file/d/1-Dx1OXsg2yuTDfyELJA2LOCaQAvIrVK2/view?usp=sharing" className="card-flower-prediction">Checkpoint
                  </a>
                </Container>
                <Container className="ne-layout-others">
                    <Row>
                        <Col xs={12} md={6} xg={6}>
                            <div>
                                ...
                                flask that takes in a flower image and uses the trained network to predict name of the flower
                                that is the nearest look-alike (neighbour) of flower present in the image.
                                </p>
                            </div>
                        </Col>
